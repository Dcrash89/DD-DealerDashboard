...
const AddGoalModal: React.FC<AddGoalModalProps> = ({ isOpen, onClose, onSave, t }) => {
    ...
    <Modal isOpen={isOpen} onClose={onClose} title={t('addGoal')}>
      <form onSubmit={handleSubmit}>
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="goalCategory" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              {t('category')}
            </label>
            <select
              id="goalCategory"
          ...
          <div>
            <label htmlFor="goalActivityType" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              {t('activityType')}
            </label>
            <select
              id="goalActivityType"
          ...
          <div>
            <label htmlFor="goalCount" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              {t('requiredCount')}
            </label>
            <input
              type="number"
