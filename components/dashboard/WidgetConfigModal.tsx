...
import { WidgetType, WidgetConfig, FormTemplate, FormFieldType, ChartType, AggregationType, DashboardWidget } from '../../types';
...
const WidgetConfigModal: React.FC<WidgetConfigModalProps> = ({ isOpen, onClose, onSave, t, formTemplates, widgetToEdit }) => {
  ...
  const selectedTemplate = formTemplates.find(ft => ft.id === config.formTemplateId);
      ...
      case WidgetType.STAT_CARD:
        return (
          <div>
            ...
            <select
              value={config.formTemplateId || ''}
              onChange={(e) => handleConfigChange('formTemplateId', e.target.value)}
