...
import { DashboardWidget, WidgetType, Dealer, FormSubmission, Goal, UserRole } from '../../types';
  ...
  const renderWidgetContent = () => {
    switch (widget.type) {
      ...
      case WidgetType.RECENT_SUBMISSIONS:
        return <RecentSubmissionsWidget config={widget.config} submissions={submissions} userRole={userRole} t={t} />;
      default:
